            ...
            <div class="col-lg-6 auth-form-wrap">
                <div class="auth-glass reveal" style="--d: .2s;">
                    ...
                    <form action="${pageContext.request.contextPath}/login" method="post" novalidate>
                        ...
                        <div class="input-wrap reveal" style="--d: .36s;">
                            <input type="password" id="loginPassword" name="password" placeholder=" " required>
                            <label for="loginPassword">Password</label>
                            <button type="button" class="toggle-eye" data-toggle-target="loginPassword" aria-label="Toggle password visibility">👁</button>
                        </div>

                        <button type="submit" class="btn-vivid reveal" style="--d: .46s;">Sign In</button>
                    </form>

                    <p class="auth-link reveal" style="--d: .54s;">
                        Don't have an account?
                        <a href="${pageContext.request.contextPath}/register">Register</a>
                    </p>

                    <jsp:useBean id="now" class="java.util.Date"/>
                    <p class="text-center mt-2 mb-0" style="color: rgba(228, 230, 248, 0.6); font-size: .78rem;">
                        Today: <fmt:formatDate value="${now}" pattern="yyyy-MM-dd"/>
                    </p>
                </div>
            </div>
        </div>
