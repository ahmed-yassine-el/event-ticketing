...
<section class="organizer-form-page dashboard-layout">
    <aside class="dashboard-sidebar">
        ...
        <a class="sidebar-link active" href="${pageContext.request.contextPath}/organizer/create-event">Create Event</a>
        ...
        <div class="form-shell">
            ...
            <form action="${pageContext.request.contextPath}/organizer/create-event" method="post" class="row g-3">
                ...
                <div class="col-md-6 location-field-wrap">
                    ...
                    <input type="text" id="eventLocation" class="form-control" name="location" required maxlength="200" autocomplete="off">
                ...
                <div class="col-12 d-none" id="locationMapWrap">
